...
:End
:Lbl A2
:Menu("Manage Items","Cursor",B1,"Grandma",B2,"Farm",B3,"Factory",B4,"Mine",B5,"Shipment",B6,"Alchemy Lab",B7,"Portal",B8,"Time Machine",B9,"Antimatter Condenser",D1,"Back",A1)
:Lbl A3
